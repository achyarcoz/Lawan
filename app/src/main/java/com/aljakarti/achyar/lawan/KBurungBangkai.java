...
public class KBurungBangkai extends AppCompatActivity {
    ViewPager viewPager;
    CustomSwip customSwip;
    ImageView imageView;
    private Integer[] imageresource ={
            R.drawable.kburungbangkai2,
            R.drawable.kburungbangkai3,
            R.drawable.kburungbangkai4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MediaPlayer mp = MediaPlayer.create(KBurungBangkai.this, R.raw.suaraburungbangkai);
                mp.start();
            }
        });
    ...
    protected void onStart() {
        ...
        text1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KBurungBangkai.this, R.raw.b);
                mp.start();
            }
        });
        ...
        text2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KBurungBangkai.this, R.raw.u);
                mp.start();
            }
        });
        ...
        text3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KBurungBangkai.this, R.raw.r);
                mp.start();
            }
        });
        ...
        text5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KBurungBangkai.this, R.raw.n);
                mp.start();
            }
        });
        ...
        text6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KBurungBangkai.this, R.raw.g);
                mp.start();
            }
        });
        ...
        text10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KBurungBangkai.this, R.raw.a);
                mp.start();
            }
        });
        ...
        text11.setBackgroundResource(android.R.color.holo_red_dark);
        ...
        text12.setBackgroundResource(android.R.color.holo_orange_light);
        ...
        text13.setBackgroundResource(android.R.color.holo_blue_dark);
        text13.setLayoutParams(params);
        text13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KBurungBangkai.this, R.raw.k);
                mp.start();
            }
        });
        ...
        text14.setBackgroundResource(android.R.color.holo_blue_dark);
        ...
        text15.setBackgroundResource(android.R.color.holo_orange_light);
        text15.setLayoutParams(params);
        text15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KBurungBangkai.this, R.raw.i);
                mp.start();
            }
        });
        ...
        playNama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KBurungBangkai.this, R.raw.abjadburungbangkai);
                mp.start();
            }
        });
