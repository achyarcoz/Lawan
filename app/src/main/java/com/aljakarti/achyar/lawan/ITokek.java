...
public class ITokek extends AppCompatActivity {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MediaPlayer mp = MediaPlayer.create(ITokek.this, R.raw.suaratokek);
                mp.start();
            }
        });
    ...
    protected void onStart() {
        ...
        text1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(ITokek.this, R.raw.t);
                mp.start();
            }
        });
        ...
        text2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(ITokek.this, R.raw.o);
                mp.start();
            }
        });
        ...
        text3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(ITokek.this, R.raw.k);
                mp.start();
            }
        });
        ...
        text4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(ITokek.this, R.raw.e);
                mp.start();
            }
        });
        ...
        playNama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(ITokek.this, R.raw.abjadtokek);
                mp.start();
            }
        });
