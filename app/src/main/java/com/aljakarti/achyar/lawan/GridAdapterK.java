...
public class GridAdapterK extends BaseAdapter {
    ...
    public GridAdapterK(Context context, String[] nHewan, Integer[] gHewan){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            gridView = inflater.inflate(R.layout.custom_layoutk, null );
        }
