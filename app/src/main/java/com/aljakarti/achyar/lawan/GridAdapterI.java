...
public class GridAdapterI extends BaseAdapter {
    ...
    public GridAdapterI(Context context, String[] nHewan, Integer[] gHewan){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            gridView = inflater.inflate(R.layout.custom_layouti, null );
        }
