...
public class KLumbaLumba extends AppCompatActivity {
    ViewPager viewPager;
    CustomSwip customSwip;
    ImageView imageView;
    private Integer[] imageresource ={
            R.drawable.klumbalumba2,
            R.drawable.klumbalumba3,
            R.drawable.klumbalumba4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MediaPlayer mp = MediaPlayer.create(KLumbaLumba.this, R.raw.suaralumbalumba);
                mp.start();
            }
        });
    ...
    protected void onStart() {
        ...
        text1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KLumbaLumba.this, R.raw.l);
                mp.start();
            }
        });
        ...
        text2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KLumbaLumba.this, R.raw.u);
                mp.start();
            }
        });
        ...
        text3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KLumbaLumba.this, R.raw.m);
                mp.start();
            }
        });
        ...
        text4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KLumbaLumba.this, R.raw.b);
                mp.start();
            }
        });
        ...
        text5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KLumbaLumba.this, R.raw.a);
                mp.start();
            }
        });
        ...
        text10.setBackgroundResource(android.R.color.holo_red_dark);
        ...
        text12.setBackgroundResource(android.R.color.holo_green_dark);
        ...
        playNama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KLumbaLumba.this, R.raw.abjadlumbalumba);
                mp.start();
            }
        });
