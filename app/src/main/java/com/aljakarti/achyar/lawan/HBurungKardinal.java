...
public class HBurungKardinal extends AppCompatActivity {
    ViewPager viewPager;
    CustomSwip customSwip;
    ImageView imageView;
    private Integer[] imageresource ={
            R.drawable.hburungkardinal2,
            R.drawable.hburungkardinal3,
            R.drawable.hburungkardinal4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.suaraburungkardinal);
                mp.start();
            }
        });
    ...
    protected void onStart() {
        ...
        text1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.b);
                mp.start();
            }
        });
        ...
        text2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.u);
                mp.start();
            }
        });
        ...
        text3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.r);
                mp.start();
            }
        });
        ...
        text5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.n);
                mp.start();
            }
        });
        ...
        text6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.g);
                mp.start();
            }
        });
        ...
        text9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.k);
                mp.start();
            }
        });
        ...
        text10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.a);
                mp.start();
            }
        });
        ...
        text11.setBackgroundResource(android.R.color.holo_orange_light);
        ...
        text12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.d);
                mp.start();
            }
        });
        ...
        text13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.i);
                mp.start();
            }
        });
        ...
        text16.setText("L");
        text16.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 25);
        text16.setBackgroundResource(android.R.color.holo_green_dark);
        text16.setLayoutParams(params);
        text16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.l);
                mp.start();
            }
        });
        ...
        playNama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(HBurungKardinal.this, R.raw.abjadburungkardinal);
                mp.start();
            }
        });
