...
public class KSinga extends AppCompatActivity {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MediaPlayer mp = MediaPlayer.create(KSinga.this, R.raw.suarasinga);
                mp.start();
            }
        });
    ...
    protected void onStart() {
        ...
        text1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KSinga.this, R.raw.s);
                mp.start();
            }
        });
        ...
        text2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KSinga.this, R.raw.i);
                mp.start();
            }
        });
        ...
        text3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KSinga.this, R.raw.n);
                mp.start();
            }
        });
        ...
        text4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KSinga.this, R.raw.g);
                mp.start();
            }
        });
        ...
        text5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KSinga.this, R.raw.a);
                mp.start();
            }
        });
        ...
        playNama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(KSinga.this, R.raw.abjadsinga);
                mp.start();
            }
        });
